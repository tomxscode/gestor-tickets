...
function pintarTabla(pagina) {
  ...
  datosPagina.forEach(function (equipo) {
    ...
    tr.innerHTML = "<td>" + equipo.id + "</td><td>" + equipo.marca + " " + equipo.modelo + "</td><td>" + equipo.serial + "</td><td>" + equipo.nombre_dueno + "</td><td><button class='btn btn-info btn-sm' onclick='prepararEdicion(" + equipo.id + ")'>Modificar</button></td>";
